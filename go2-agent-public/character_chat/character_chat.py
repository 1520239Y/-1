...
def main():
    openai.api_key = os.environ['sk-D77BfxwDVSIepTaYHpzaZghwG7PImoBCI8WVa0n498T3BlbkFJ9ZLFtqTb7HhhUAppO35bXZAbhc-lzYYe5J0oGvfSwA']
...
class Chat:
    ...
    def __init__(self, initial_prompt=None, model="gpt-4o", show_retry_message=False):
        self.__messages = []
        self.__model = model
